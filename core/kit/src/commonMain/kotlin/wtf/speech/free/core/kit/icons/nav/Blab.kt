...
public val SpeechIcons.Nav.Blab: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Nav.Blab",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
...
@Preview
@Composable
private fun BlabPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = SpeechIcons.Nav.Blab, contentDescription = null)
    }
}
