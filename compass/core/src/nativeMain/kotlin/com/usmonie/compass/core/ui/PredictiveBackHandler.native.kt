...
public actual fun PredictiveBackHandler(
    ...
    val pointerInput: suspend PointerInputScope.() -> Unit = remember(enabled, isGestureEnabled) {
        {
            ...
            detectHorizontalDragGestures(
                onDragStart = {
                    ...
                    onBackInstance?.send(Gesture.Start(it.x, it.y, size.width.toFloat(), Edge.LEFT_TO_RIGHT))
                },
                onDragEnd = {
                    // regular back.
